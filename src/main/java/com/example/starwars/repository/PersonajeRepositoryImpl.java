...
public class PersonajeRepositoryImpl implements IPersonajeRepository {
    ...
    public void readJsonFile(){
        try {
            ...
            personajes = List.of(mapper.readValue(new File("/Users/svillegasbed/Documents/bootcamp/springboot/starwars/src/main/resources/starwars.json"), Personaje[].class));
